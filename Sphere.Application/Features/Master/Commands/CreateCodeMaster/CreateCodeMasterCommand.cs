...
/// <summary>
/// Command to create a new code master.
/// </summary>
public record CreateCodeMasterCommand : IRequest<Result<CodeMasterResultDto>>
{
    /// <summary>
    ...
    /// <summary>
    /// Code ID (unique identifier within class).
    /// </summary>
    public string CodeId { get; init; } = string.Empty;

    /// <summary>
    /// Code class ID (category).
    /// </summary>
